...
int length=0,w=0,i=0,count=0,addr,ptaddr,taddr,address,baseaddr,l,k,start,end;
FILE *fp1,*fp2;
void check();
void main()
{
    ...
    printf("Enter the start address to relocate:");
    scanf("%x",&baseaddr);
    baseaddr=baseaddr-4096;
    fscanf(fp1,"%s",input);
